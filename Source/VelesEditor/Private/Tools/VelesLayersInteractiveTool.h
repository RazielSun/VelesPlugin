...
#include "VelesLayersInteractiveTool.generated.h"


/**
 * Builder for UVelesLayersInteractiveTool
 */
UCLASS()
class UVelesLayersInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UVelesLayersInteractiveTool
 */
UCLASS(Transient)
class UVelesLayersInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UVelesLayersInteractiveToolProperties();
...
/**
 * UVelesLayersInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class UVelesLayersInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UVelesLayersInteractiveToolProperties> Properties;
