...
#include "VelesLayersInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UVelesLayersInteractiveTool"

/*
 * ToolBuilder
 */

bool UVelesLayersInteractiveToolBuilder::CanBuildTool(const FToolBuilderState& SceneState) const
{
	UVelesLayersEditorMode* EdMode = Cast<UVelesLayersEditorMode>(GetOuter());
	return EdMode ? EdMode->CurrentToolMode >= EVelesLayersToolMode::Modify : false;
}

UInteractiveTool* UVelesLayersInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UVelesLayersInteractiveTool* NewTool = NewObject<UVelesLayersInteractiveTool>(SceneState.ToolManager);
...
UVelesLayersInteractiveToolProperties::UVelesLayersInteractiveToolProperties()
{
...
void UVelesLayersInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UVelesLayersInteractiveTool::Setup()
{
	...
	Properties = NewObject<UVelesLayersInteractiveToolProperties>(this, "Measurement");
...
void UVelesLayersInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UVelesLayersInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UVelesLayersInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UVelesLayersInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UVelesLayersInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UVelesLayersInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UVelesLayersInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UVelesLayersInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UVelesLayersInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
